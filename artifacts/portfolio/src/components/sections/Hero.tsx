    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div 
          ...
          className="absolute top-1/4 -left-1/4 w-[800px] h-[800px] bg-primary/30 rounded-full blur-[120px]" 
        />
        <motion.div 
          animate={{ scale: [1, 1.3, 1], opacity: [0.1, 0.3, 0.1] }}
          transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 2 }}
          className="absolute bottom-1/4 -right-1/4 w-[600px] h-[600px] bg-accent/30 rounded-full blur-[100px]" 
        />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel mb-8 border-primary/30 glow-primary"
        >
        ...
        >
          {['React', 'Node.js', 'AWS', 'TypeScript', 'Python'].map((badge, i) => (
            <motion.div
              ...
              className="px-4 py-1.5 rounded-full text-xs font-medium text-white/70 glass-panel border-white/10"
            >
              {badge}
            </motion.div>
          ))}
      ...
      <motion.div 
        ...
        className="absolute bottom-24 w-full flex flex-col items-center justify-center opacity-50 hover:opacity-100 transition-opacity duration-500"
      >
